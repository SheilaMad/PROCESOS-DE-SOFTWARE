...
{ $errormsg = "<div class='alert alert-success'> <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong>Success!</strong>Estudiante añadido exitosamente</div>";
}else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="2")
{ $errormsg = "<div class='alert alert-success'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> <strong>Success!</strong> Estudiante Modificado exitosamente</div>";
}
else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="3")
{ $errormsg = "<div class='alert alert-success'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong>Success!</strong>Estudiante eliminado exitosamente</div>";
}
?>
<!DOCTYPE html>
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
						...
						' <a href="student.php" class="btn btn-primary btn-sm pull-right">Regresar <i class="glyphicon glyphicon-arrow-right"></i></a>':'<a href="student.php?action=add" class="btn btn-primary btn-sm pull-right"><i class="glyphicon glyphicon-plus"></i> Añadir </a>';
						?>
						</h1>
		...
		?>
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-primary">
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Programa* </label>
								<div class="col-sm-10">
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Pago total* </label>
								<div class="col-sm-10">
						...
						<?php} ?>
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Presupuesto </label>
								<div class="col-sm-10">
						...
						{ ?>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Password">Comentario de Pago </label>
								<div class="col-sm-10">
...
yearRange: "1970:<?php echo date('Y');?>"
   ...
   <div id="footer-sec">
       Sistema de Matricula | Derecho Reservado : <a href="" target="_blank">Procesos</a>
    </div>
