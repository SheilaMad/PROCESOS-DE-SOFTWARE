...
{ $errormsg = "<div class='alert alert-success'><strong>Success!</strong>Se añadio curso exitosamente</div>";}
  else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="2")
{ $errormsg = "<div class='alert alert-success'><strong>Success!</strong>se modifico curso exitosamente</div>"; }
else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="3")
{ $errormsg = "<div class='alert alert-success'><strong>Success!</strong>se elimino curso exitosamente</div>";
}
?>
<!DOCTYPE html>
			...
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-primary">
                        <div class="panel-heading">
                           <?php echo ($action=="add")? "Añadir Sede": "Edit Branch"; ?>
                        </div>
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">PROGRAMAS</label>
								<div class="col-sm-10">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Password"> MODULO</label>
								<div class="col-sm-10">
